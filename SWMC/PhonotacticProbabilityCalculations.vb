...
Public Class PhonoTactics
    ...
    Public Sub ExportTransitionalProbabilityData(ByVal saveDirectory As String, Optional ByRef saveFileName As String = "SyllableBasedPhonemeTransitionalProbabilities",
